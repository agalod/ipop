========================================================================
       STATISCHE BIBLIOTHEK : IMP
========================================================================


Diese IMP-Bibliothek hat der Anwendungs-Assistent für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, die Ihre IMP-Anwendung bilden.

/////////////////////////////////////////////////////////////////////////////

StdAfx.h, StdAfx.cpp
    Diese Dateien werden zum Erstellen einer vorkompilierten Header-Datei (PCH) namens
    IMP.pch und einer vorkompilierten Typdatei namens StdAfx.obj verwendet.
...
Hinzufügen verschiedener Dateien zum Projekt, einschließlich "resource.h", "IMP.rc" 
und einer "IMP.h", die resource.h einbezieht. Wenn Sie einer statischen Bibliothek 
