========================================================================
       STATISCHE BIBLIOTHEK : IMG
========================================================================


Diese IMG-Bibliothek hat der Anwendungs-Assistent für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, die Ihre IMG-Anwendung bilden.

/////////////////////////////////////////////////////////////////////////////

StdAfx.h, StdAfx.cpp
    Diese Dateien werden zum Erstellen einer vorkompilierten Header-Datei (PCH) namens
    IMG.pch und einer vorkompilierten Typdatei namens StdAfx.obj verwendet.
...
Hinzufügen verschiedener Dateien zum Projekt, einschließlich "resource.h", "IMG.rc" 
und einer "IMG.h", die resource.h einbezieht. Wenn Sie einer statischen Bibliothek 
