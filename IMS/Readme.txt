========================================================================
       STATISCHE BIBLIOTHEK : IMS
========================================================================


Diese IMS-Bibliothek hat der Anwendungs-Assistent für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, die Ihre IMS-Anwendung bilden.

/////////////////////////////////////////////////////////////////////////////

StdAfx.h, StdAfx.cpp
    Diese Dateien werden zum Erstellen einer vorkompilierten Header-Datei (PCH) namens
    IMS.pch und einer vorkompilierten Typdatei namens StdAfx.obj verwendet.
...
Hinzufügen verschiedener Dateien zum Projekt, einschließlich "resource.h", "IMS.rc" 
und einer "IMS.h", die resource.h einbezieht. Wenn Sie einer statischen Bibliothek 
