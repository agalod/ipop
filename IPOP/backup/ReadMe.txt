========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : IPOP
========================================================================


Diese IPOP-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\IPOP.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei IPOP.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in IPOP.rc, um Schaltflächen für die
...
IPOPDoc.h, IPOPDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CIPOPDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CIPOPDoc::Serialize).

IPOPView.h, IPOPView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CIPOPView.
    	CIPOPView-Objekte werden verwendet, um CIPOPDoc-Objekte anzuzeigen.

res\IPOPDoc.ico
    	Dies ist eine Symboldatei, die als Symbol für untergeordnete MDI-Fenster 
	der Klasse CIPOPDoc verwendet wird. Dieses Symbol wird durch die
	Haupt-Ressourcendatei IPOP.rc eingebunden.
...
StdAfx.h, StdAfx.cpp
	...
	IPOP.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
