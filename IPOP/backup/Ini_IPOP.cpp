...
void CIni_Camera::Set_CameraMat(float* aCameraMat)
{
	for(int i=0;i<9;i++)
...
void CIni_Camera::Set_DistortionVec(float* aDistortionVec)
{
...
void CIni_Camera::Set_CellSize(float x, float y)
{
	m_Int_CellSize[0] = x;
	m_Int_CellSize[1] = y;
}

float CIni_Camera::Get_FocLen()
{
	return m_Int_FocLen[0];
}

float CIni_Camera::Get_CellSizeX()
{
	return m_Int_CellSize[0];
}

float CIni_Camera::Get_CellSizeY()
{
...
void CIni_Camera::Set_FocLen(float aFocLen)
{
