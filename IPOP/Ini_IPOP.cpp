// CIni_IPOP.cpp: Implementierung der Klasse CIni_IPOP.
//
//////////////////////////////////////////////////////////////////////
...
CIni_IPOP::CIni_IPOP(CString Verz, CString Datei)
{
...
CharType CIni_IPOP::CharacterType( char zeichen )
{
	CharReturn ret;
...
void CIni_IPOP::INI_LesenFileDialog()
{
	m_File.Abort();
...
void CIni_IPOP::Read_PrincipalPoint(){
...
void CIni_IPOP::Read_DistortionMatlab(){
...
void CIni_IPOP::Read_CameraMatrix()
{
	CharReturn chartype;
...
void CIni_IPOP::Read_Distortion()
{
	m_File.ReadString(m_CurrLine); 
	if(m_CurrLine.GetLength()==0) return;
	m_StringArray.Add(m_CurrLine);
...
void CIni_IPOP::INI_SchreibenFileDialog()
{
...
void CIni_IPOP::Set_ImageSize(int x, int y)
{
	m_Int_ImageSize[0] = x;
	m_Int_ImageSize[1] = y;
}
...
void CIni_IPOP::Set_CameraMat(float* aCameraMat)
{
	for(int i=0;i<9;i++)
...
void CIni_IPOP::Set_DistortionVec(float* aDistortionVec)
{
